...
export const mediaV4Api = {
  ...
  startDurableScan: (request: {
    ...
    revision_id?: string
    source_display_name?: string
    /** 继续一次因请求预算暂停的扫描：必须复用同一 scan_id，后端才从断点续扫。 */
    resume_scan_id?: string
