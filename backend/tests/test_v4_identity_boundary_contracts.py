...
def test_cjk_episode_numbering_is_recognized():
    ...
    parser = V4Parser()
    # 规则矩阵：每一行都是**用户真实库里的文件名**（来自 OpenList 中文库两次扫描）。
    # 新增命名形态时只允许**追加行**，不得修改既有行的期望值——这就是"规则可增量更新"
    # 的回归网：任何一次改动若影响了旧形态，本用例会立刻报出是哪一行。
    cases = {
        # ① 第N集 / 第N话
        "夸克网盘/动画/宝可梦国语三/超级愿望/第002集.mp4": 2,
        "夸克网盘/动画/宝可梦国语三/超级愿望/第001集.mp4": 1,
        # ② 第N + 中文（命名手误，实测 `第062第.mp4`）
        ...
        "夸克网盘/动画/宝可梦国语三/无印篇/01宝可梦，就决定是你了！.MP4": 1,
        "夸克网盘/动画/宝可梦国语三/超世代/21集刺尾虫对刺尾虫！到底是哪一只？.flv": 21,
        "夸克网盘/动画/宝可梦国语三/超世代/23海边的捣蛋鬼，龙虾小兵登场！.mp4": 23,
        # ④ 前导数字 + 空格 + 中文
        "夸克网盘/动画/宝可梦国语三/无印篇/114 再见了，拉普拉斯！.MP4": 114,
        "夸克网盘/动画/宝可梦国语三/钻石与珍珠/181 开幕！神奥联盟‧铃兰大会.mp4": 181,
        # ⑤ 发布组前缀 + 前导数字（`(2)` 不得被当成绝对集号）
        "夸克网盘/动画/宝可梦国语三/超世代/[Group] 121热斗！大型庆典(2)!!.mp4": 121,
        "夸克网盘/动画/宝可梦国语三/超世代/【组】122热斗！大型庆典(3)!!.mp4": 122,
    }
